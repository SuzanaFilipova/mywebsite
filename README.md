...
div.metal a.active {
 ...
 <div class="metal" style="border-style:double;border-width: 10px;">
    <a href="proekt.html">Още информация за групата</a>
      <a href="proekt1.html">Песни - превод</a>
          ...
          <table>
            <tr>
                <td>
                    ...
                    <p style="color: aliceblue; font-size: 20px;" align="center">Flake през 90-те</p>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/b/b0/RammsteinFlake.jpg" width="350px" height="500">
                    <p style="color: aliceblue; font-size: 20px;" align="center">Flake сега</p>
                </td>
                <td>
                   <p style="color: aliceblue; font-size: 45px;" align="center">Роден е на 16 ноември, 1966 в Берлин. Неговото семейно минало е неясно. Лоренц има брат който е с 3 години по-голям. Той е отраснал и още живее на родното си място район Пренслауер Берг (Prenzlauer Berg), Берлин (сега част от предградието Панков), където той още минава край старото си училище по пътя към репетициите на групата.
